...
<body class="hold-transition login-page" style="background: linear-gradient(to right, #6a11cb, #2575fc); height: 100vh; font-family: 'Poppins', sans-serif; margin: 0; display: flex; justify-content: center; align-items: center;">

<!-- Login Box -->
<div class="login-box" style="background-color: rgba(255, 255, 255, 0.9); padding: 30px; border-radius: 10px; box-shadow: 0 15px 30px rgba(0, 0, 0, 0.1); width: 100%; max-width: 400px;">

   <!-- Logo and Heading -->
   <div class="login-logo" style="text-align: center; margin-bottom: 20px;">
      <h2 style="color: #333; font-weight: 700; font-size: 26px;">Admin Login</h2>
   </div>

   <!-- Login Form -->
   <div class="login-box-body">
      <p class="login-box-msg" style="text-align: center; color: #555; font-size: 16px; margin-bottom: 30px;">Sign in to start your session</p>
